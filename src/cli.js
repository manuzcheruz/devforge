...
class CLI {
    ...
    setupCommands() {
        ...
        this.program
            ...
            .action(async (options) => {
                const devForge = require('./index');
                await devForge.syncEnvironment(options);
            });
        ...
        this.program
            ...
            .action(async (options) => {
                const devForge = require('./index');
                await devForge.manageAPI(options);
            });
        ...
        this.program
            ...
            .action(async (options) => {
                const devForge = require('./index');
                await devForge.manageMicroservices(options);
            });
        ...
        this.program
            ...
            .action(async (options) => {
                const devForge = require('./index');
                await devForge.optimizePerformance(options);
            });
        ...
        this.program
            ...
            .action(async (options) => {
                const devForge = require('./index');
                await devForge.analyzeSecurity(options);
            });
        ...
        this.program
            ...
            .action(async (options) => {
                const devForge = require('./index');
                await devForge.manageDatabase(options);
            });
